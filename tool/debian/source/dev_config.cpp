...
bool DevConfig::parse_id_json(char* _id_json) {
    ...
    KeyList key_list[] = {
        ...
        { "partition-label",      id.partition_label,      sizeof (id.partition_label)      },
        { "partition-size",       id.partition_size,       sizeof (id.partition_size)       },
        { "flash-chip-id",        id.flash_chip_id,        sizeof (id.flash_chip_id)        },
