...
#define IDS_DISPLAY_TYPE            (56)

#define IDS_PROGRAM_DEV             (57)
#define IDS_RESET_DEVICE            (58)
#define IDS_INITIALIZE_DEVICE       (59)
#define IDS_LOADING                 (60)
#define IDS_CONNECTED               (61)
#define IDS_NOT_CONNECTED           (62)
#define IDS_SCANNING                (63)
#define IDS_INITIALIZING            (64)
#define IDS_RELOAD_DATA             (65)
#define IDS_FIRMWARE_UPLOAD         (66)
#define IDS_EXEC_COMMAND            (67)

#define IDS_ERROR_NO_DEV_CONNECTED  (68)
#define IDS_ERROR_CFG_READ_ERROR    (69)

#define IDS_LIST_ENABLE_DISABLE     (70)
#define IDS_LIST_SENSOR_TYPES       (71)
#define IDS_LIST_DISPLAY_TIMEOUTS   (72)
#define IDS_LIST_DISPLAY_CONTRAST   (73)
#define IDS_LIST_DISPLAY_PAGE       (74)
#define IDS_LIST_DISPLAY_ROTATION   (75)
#define IDS_LIST_LED_INTENSITY      (76)

#define IDS_DEVICE_MENU             (77)
#define IDS_MAIN                    (78)
#define IDS_EXIT                    (79)
#define IDS_TITLE_MAIN              (80)
#define IDS_LAYOUT                  (81)
#define IDS_CONFIG                  (82)
#define IDS_REBOOT                  (83)
#define IDS_FACTORY_RESET           (84)
#define IDS_TITLE_DISPLAY           (85)
#define IDS_ROTATE                  (86)
#define IDS_CONTRAST                (87)
#define IDS_DISPLAY_OFF             (88)
#define IDS_TITLE_CONFIG            (89)
#define IDS_DISPLAY                 (90)
#define IDS_INTENSITY               (91)
#define IDS_MQTT_CLIENT             (92)
#define IDS_CONFIG_INTERFACE        (93)
#define IDS_SENSOR_SELECT           (94)
#define IDS_TITLE_CONTRAST          (95)
#define IDS_CONTRAST_100            (96)
#define IDS_CONTRAST_80             (97)
#define IDS_CONTRAST_60             (98)
#define IDS_CONTRAST_50             (99)
#define IDS_CONTRAST_40             (100)
#define IDS_CONTRAST_30             (101)
#define IDS_CONTRAST_20             (102)
#define IDS_CONTRAST_10             (103)
#define IDS_TITLE_LAYOUT            (104)
#define IDS_LAYOUT_VALUE_PAGE       (105)
#define IDS_LAYOUT_DETAILS_PAGE     (106)
#define IDS_LAYOUT_INFO_PAGE        (107)
#define IDS_TITLE_TIMEOUT           (108)
#define IDS_DISPLAY_OFF_NEVER       (109)
#define IDS_DISPLAY_OFF_10SEC       (110)
#define IDS_DISPLAY_OFF_1MIN        (111)
#define IDS_DISPLAY_OFF_5MIN        (112)
#define IDS_DISPLAY_OFF_15MIN       (113)
#define IDS_DISPLAY_OFF_30MIN       (114)
#define IDS_TITLE_LED_INTENSITY     (115)
#define IDS_LED_INTENSITY_100       (116)
#define IDS_LED_INTENSITY_75        (117)
#define IDS_LED_INTENSITY_50        (118)
#define IDS_LED_INTENSITY_25        (119)
#define IDS_LED_INTENSITY_10        (120)
#define IDS_LED_INTENSITY_1         (121)
