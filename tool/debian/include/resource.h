...
#define IDS_ERROR_NO_DEV_CONNECTED  (60)
#define IDS_ERROR_CFG_READ_ERROR    (61)

#define IDS_LIST_ENABLE_DISABLE     (62)
#define IDS_LIST_SENSOR_TYPES       (63)
#define IDS_LIST_DISPLAY_TIMEOUTS   (64)
#define IDS_LIST_DISPLAY_CONTRAST   (65)
#define IDS_LIST_DISPLAY_PAGE       (66)
#define IDS_LIST_DISPLAY_ROTATION   (67)
#define IDS_LIST_LED_INTENSITY      (68)

#define IDS_DEVICE_MENU             (69)
#define IDS_MAIN                    (70)
#define IDS_EXIT                    (71)
#define IDS_TITLE_MAIN              (72)
#define IDS_LAYOUT                  (73)
#define IDS_CONFIG                  (74)
#define IDS_REBOOT                  (75)
#define IDS_FACTORY_RESET           (76)
#define IDS_TITLE_DISPLAY           (77)
#define IDS_ROTATE                  (78)
#define IDS_CONTRAST                (79)
#define IDS_DISPLAY_OFF             (80)
#define IDS_TITLE_CONFIG            (81)
#define IDS_DISPLAY                 (82)
#define IDS_INTENSITY               (83)
#define IDS_MQTT_CLIENT             (84)
#define IDS_CONFIG_INTERFACE        (85)
#define IDS_SENSOR_SELECT           (86)
#define IDS_TITLE_CONTRAST          (87)
#define IDS_CONTRAST_100            (88)
#define IDS_CONTRAST_80             (89)
#define IDS_CONTRAST_60             (90)
#define IDS_CONTRAST_50             (91)
#define IDS_CONTRAST_40             (92)
#define IDS_CONTRAST_30             (93)
#define IDS_CONTRAST_20             (94)
#define IDS_CONTRAST_10             (95)
#define IDS_TITLE_LAYOUT            (96)
#define IDS_LAYOUT_VALUE_PAGE       (97)
#define IDS_LAYOUT_DETAILS_PAGE     (98)
#define IDS_LAYOUT_INFO_PAGE        (99)
#define IDS_TITLE_TIMEOUT           (100)
#define IDS_DISPLAY_OFF_NEVER       (101)
#define IDS_DISPLAY_OFF_10SEC       (102)
#define IDS_DISPLAY_OFF_1MIN        (103)
#define IDS_DISPLAY_OFF_5MIN        (104)
#define IDS_DISPLAY_OFF_15MIN       (105)
#define IDS_DISPLAY_OFF_30MIN       (106)
#define IDS_TITLE_LED_INTENSITY     (107)
#define IDS_LED_INTENSITY_100       (108)
#define IDS_LED_INTENSITY_75        (109)
#define IDS_LED_INTENSITY_50        (110)
#define IDS_LED_INTENSITY_25        (111)
#define IDS_LED_INTENSITY_10        (112)
#define IDS_LED_INTENSITY_1         (113)
