...
#define IDS_TIME_DATE               (49)

#define IDS_PROGRAM_DEV             (50)
#define IDS_RESET_DEVICE            (51)
#define IDS_INITIALIZE_DEVICE       (52)
#define IDS_LOADING                 (53)
#define IDS_CONNECTED               (54)
#define IDS_NOT_CONNECTED           (55)
#define IDS_SCANNING                (56)
#define IDS_INITIALIZING            (57)
#define IDS_RELOAD_DATA             (58)
#define IDS_FIRMWARE_UPLOAD         (59)
#define IDS_EXEC_COMMAND            (60)

#define IDS_ERROR_NO_DEV_CONNECTED  (61)
#define IDS_ERROR_CFG_READ_ERROR    (62)

#define IDS_LIST_ENABLE_DISABLE     (63)
#define IDS_LIST_SENSOR_TYPES       (64)
#define IDS_LIST_DISPLAY_TIMEOUTS   (65)
#define IDS_LIST_DISPLAY_CONTRAST   (66)
#define IDS_LIST_DISPLAY_PAGE       (67)
#define IDS_LIST_DISPLAY_ROTATION   (68)
#define IDS_LIST_LED_INTENSITY      (69)

#define IDS_DEVICE_MENU             (70)
#define IDS_MAIN                    (71)
#define IDS_EXIT                    (72)
#define IDS_TITLE_MAIN              (73)
#define IDS_LAYOUT                  (74)
#define IDS_CONFIG                  (75)
#define IDS_REBOOT                  (76)
#define IDS_FACTORY_RESET           (77)
#define IDS_TITLE_DISPLAY           (78)
#define IDS_ROTATE                  (79)
#define IDS_CONTRAST                (80)
#define IDS_DISPLAY_OFF             (81)
#define IDS_TITLE_CONFIG            (82)
#define IDS_DISPLAY                 (83)
#define IDS_INTENSITY               (84)
#define IDS_MQTT_CLIENT             (85)
#define IDS_CONFIG_INTERFACE        (86)
#define IDS_SENSOR_SELECT           (87)
#define IDS_TITLE_CONTRAST          (88)
#define IDS_CONTRAST_100            (89)
#define IDS_CONTRAST_80             (90)
#define IDS_CONTRAST_60             (91)
#define IDS_CONTRAST_50             (92)
#define IDS_CONTRAST_40             (93)
#define IDS_CONTRAST_30             (94)
#define IDS_CONTRAST_20             (95)
#define IDS_CONTRAST_10             (96)
#define IDS_TITLE_LAYOUT            (97)
#define IDS_LAYOUT_VALUE_PAGE       (98)
#define IDS_LAYOUT_DETAILS_PAGE     (99)
#define IDS_LAYOUT_INFO_PAGE        (100)
#define IDS_TITLE_TIMEOUT           (101)
#define IDS_DISPLAY_OFF_NEVER       (102)
#define IDS_DISPLAY_OFF_10SEC       (103)
#define IDS_DISPLAY_OFF_1MIN        (104)
#define IDS_DISPLAY_OFF_5MIN        (105)
#define IDS_DISPLAY_OFF_15MIN       (106)
#define IDS_DISPLAY_OFF_30MIN       (107)
#define IDS_TITLE_LED_INTENSITY     (108)
#define IDS_LED_INTENSITY_100       (109)
#define IDS_LED_INTENSITY_75        (110)
#define IDS_LED_INTENSITY_50        (111)
#define IDS_LED_INTENSITY_25        (112)
#define IDS_LED_INTENSITY_10        (113)
#define IDS_LED_INTENSITY_1         (114)
