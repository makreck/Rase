...
#define APP_WINDOW_DEF_HEIGHT       (912)
...
#define IDS_PARTITION_LABEL         (45)
#define IDS_PARTITION_SIZE          (46)
#define IDS_FLASH_CHIP_ID           (47)
#define IDS_FLASH_CHIP_SIZE         (48)
#define IDS_SPI_RAM_SIZE            (49)
#define IDS_HEAP_SIZE               (50)
#define IDS_WIFI_RSSI               (51)
#define IDS_WIFI_TX_POWER           (52)
#define IDS_SENSOR_HEAD             (53)
#define IDS_HEAD_SERIAL_NO          (54)
#define IDS_TIME_DATE               (55)

#define IDS_PROGRAM_DEV             (56)
#define IDS_RESET_DEVICE            (57)
#define IDS_INITIALIZE_DEVICE       (58)
#define IDS_LOADING                 (59)
#define IDS_CONNECTED               (60)
#define IDS_NOT_CONNECTED           (61)
#define IDS_SCANNING                (62)
#define IDS_INITIALIZING            (63)
#define IDS_RELOAD_DATA             (64)
#define IDS_FIRMWARE_UPLOAD         (65)
#define IDS_EXEC_COMMAND            (66)

#define IDS_ERROR_NO_DEV_CONNECTED  (67)
#define IDS_ERROR_CFG_READ_ERROR    (68)

#define IDS_LIST_ENABLE_DISABLE     (69)
#define IDS_LIST_SENSOR_TYPES       (70)
#define IDS_LIST_DISPLAY_TIMEOUTS   (71)
#define IDS_LIST_DISPLAY_CONTRAST   (72)
#define IDS_LIST_DISPLAY_PAGE       (73)
#define IDS_LIST_DISPLAY_ROTATION   (74)
#define IDS_LIST_LED_INTENSITY      (75)

#define IDS_DEVICE_MENU             (76)
#define IDS_MAIN                    (77)
#define IDS_EXIT                    (78)
#define IDS_TITLE_MAIN              (79)
#define IDS_LAYOUT                  (80)
#define IDS_CONFIG                  (81)
#define IDS_REBOOT                  (82)
#define IDS_FACTORY_RESET           (83)
#define IDS_TITLE_DISPLAY           (84)
#define IDS_ROTATE                  (85)
#define IDS_CONTRAST                (86)
#define IDS_DISPLAY_OFF             (87)
#define IDS_TITLE_CONFIG            (88)
#define IDS_DISPLAY                 (89)
#define IDS_INTENSITY               (90)
#define IDS_MQTT_CLIENT             (91)
#define IDS_CONFIG_INTERFACE        (92)
#define IDS_SENSOR_SELECT           (93)
#define IDS_TITLE_CONTRAST          (94)
#define IDS_CONTRAST_100            (95)
#define IDS_CONTRAST_80             (96)
#define IDS_CONTRAST_60             (97)
#define IDS_CONTRAST_50             (98)
#define IDS_CONTRAST_40             (99)
#define IDS_CONTRAST_30             (100)
#define IDS_CONTRAST_20             (101)
#define IDS_CONTRAST_10             (102)
#define IDS_TITLE_LAYOUT            (103)
#define IDS_LAYOUT_VALUE_PAGE       (104)
#define IDS_LAYOUT_DETAILS_PAGE     (105)
#define IDS_LAYOUT_INFO_PAGE        (106)
#define IDS_TITLE_TIMEOUT           (107)
#define IDS_DISPLAY_OFF_NEVER       (108)
#define IDS_DISPLAY_OFF_10SEC       (109)
#define IDS_DISPLAY_OFF_1MIN        (110)
#define IDS_DISPLAY_OFF_5MIN        (111)
#define IDS_DISPLAY_OFF_15MIN       (112)
#define IDS_DISPLAY_OFF_30MIN       (113)
#define IDS_TITLE_LED_INTENSITY     (114)
#define IDS_LED_INTENSITY_100       (115)
#define IDS_LED_INTENSITY_75        (116)
#define IDS_LED_INTENSITY_50        (117)
#define IDS_LED_INTENSITY_25        (118)
#define IDS_LED_INTENSITY_10        (119)
#define IDS_LED_INTENSITY_1         (120)
