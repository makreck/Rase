...
#define IDS_NOT_CONNECTED           (54)
#define IDS_SCANNING                (55)
#define IDS_INITIALIZING            (56)
#define IDS_RELOAD_DATA             (57)

#define IDS_ERROR_NO_DEV_CONNECTED  (58)
#define IDS_ERROR_CFG_READ_ERROR    (59)

#define IDS_LIST_ENABLE_DISABLE     (60)
#define IDS_LIST_SENSOR_TYPES       (61)
#define IDS_LIST_DISPLAY_TIMEOUTS   (62)
#define IDS_LIST_DISPLAY_CONTRAST   (63)
#define IDS_LIST_DISPLAY_PAGE       (64)
#define IDS_LIST_DISPLAY_ROTATION   (65)
#define IDS_LIST_LED_INTENSITY      (66)

#define IDS_DEVICE_MENU             (67)
#define IDS_MAIN                    (68)
#define IDS_EXIT                    (69)
#define IDS_TITLE_MAIN              (70)
#define IDS_LAYOUT                  (71)
#define IDS_CONFIG                  (72)
#define IDS_REBOOT                  (73)
#define IDS_FACTORY_RESET           (74)
#define IDS_TITLE_DISPLAY           (75)
#define IDS_ROTATE                  (76)
#define IDS_CONTRAST                (77)
#define IDS_DISPLAY_OFF             (78)
#define IDS_TITLE_CONFIG            (79)
#define IDS_DISPLAY                 (80)
#define IDS_INTENSITY               (81)
#define IDS_MQTT_CLIENT             (82)
#define IDS_CONFIG_INTERFACE        (83)
#define IDS_SENSOR_SELECT           (84)
#define IDS_TITLE_CONTRAST          (85)
#define IDS_CONTRAST_100            (86)
#define IDS_CONTRAST_80             (87)
#define IDS_CONTRAST_60             (88)
#define IDS_CONTRAST_50             (89)
#define IDS_CONTRAST_40             (90)
#define IDS_CONTRAST_30             (91)
#define IDS_CONTRAST_20             (92)
#define IDS_CONTRAST_10             (93)
#define IDS_TITLE_LAYOUT            (94)
#define IDS_LAYOUT_VALUE_PAGE       (95)
#define IDS_LAYOUT_DETAILS_PAGE     (96)
#define IDS_LAYOUT_INFO_PAGE        (97)
#define IDS_TITLE_TIMEOUT           (98)
#define IDS_DISPLAY_OFF_NEVER       (99)
#define IDS_DISPLAY_OFF_10SEC       (100)
#define IDS_DISPLAY_OFF_1MIN        (101)
#define IDS_DISPLAY_OFF_5MIN        (102)
#define IDS_DISPLAY_OFF_15MIN       (103)
#define IDS_DISPLAY_OFF_30MIN       (104)
#define IDS_TITLE_LED_INTENSITY     (105)
#define IDS_LED_INTENSITY_100       (106)
#define IDS_LED_INTENSITY_75        (107)
#define IDS_LED_INTENSITY_50        (108)
#define IDS_LED_INTENSITY_25        (109)
#define IDS_LED_INTENSITY_10        (110)
#define IDS_LED_INTENSITY_1         (111)
#define IDS_FORMWARE_UPLOAD         (112)
