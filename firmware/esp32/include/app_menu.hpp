...
#define IDM_LED_COLOR_ORDER      (6)
#define IDM_SENSOR_SELECT        (7)
#define IDM_FACTORY_RESET        (8)
#define IDM_REBOOT               (9)
#define IDM_CONFIG               (10)
#define IDM_CONTRAST             (11)
#define IDM_DISPLAY_OFF          (12)
#define IDM_ROTATE  	         (13)
#define IDM_CONFIG_INTERFACE     (14)
#define IDM_MQTT_CLIENT          (15)
...
#define IDM_CONTRAST_100         (IDM_CONTRAST_BASE + 0)
#define IDM_CONTRAST_90          (IDM_CONTRAST_BASE + 1)
#define IDM_CONTRAST_80          (IDM_CONTRAST_BASE + 2)
#define IDM_CONTRAST_70          (IDM_CONTRAST_BASE + 3)
#define IDM_CONTRAST_60          (IDM_CONTRAST_BASE + 4)
#define IDM_CONTRAST_50          (IDM_CONTRAST_BASE + 5)
#define IDM_CONTRAST_40          (IDM_CONTRAST_BASE + 6)
#define IDM_CONTRAST_30          (IDM_CONTRAST_BASE + 7)
#define IDM_CONTRAST_20          (IDM_CONTRAST_BASE + 8)
#define IDM_CONTRAST_10          (IDM_CONTRAST_BASE + 9)
...
#define IDM_LED_COLOR_ORDER_BASE (60)
#define IDM_LED_COLOR_ORDER_RGB  (IDM_LED_COLOR_ORDER_BASE + 0)
#define IDM_LED_COLOR_ORDER_BRG  (IDM_LED_COLOR_ORDER_BASE + 1)
#define IDM_LED_COLOR_ORDER_BGR  (IDM_LED_COLOR_ORDER_BASE + 2)

#define IDM_SENSOR_BASE          (70)
